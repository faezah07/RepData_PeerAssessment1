...
dev.copy(png,'question1.png') #saving to file
dev.off()
...
dev.copy(png,'question2.png') #saving to file
dev.off()
...
dev.copy(png,'question3.png') #saving to file
dev.off()
...
dev.copy(png,'question4.png') #saving to file
dev.off()
